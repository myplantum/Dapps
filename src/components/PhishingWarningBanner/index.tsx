...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("please make sure you're visiting https://fourswap.xyz - check the URL carefully.")
    return warningText.split(/(https:\/\/fourswap.xyz)/g)
  }, [t])
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://fourswap.xyz'}
          color={text === 'https://fourswap.xyz' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
