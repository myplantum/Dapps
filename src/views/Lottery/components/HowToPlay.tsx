          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                ...
                <InlineLink href="https://docs.fourswap.xyz/tokenomics/cake/cake-tokenomics">
                  {t('CAKE Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.fourswap.xyz/products/lottery/lottery-guide">
              {t('how to play the FourSwap lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
